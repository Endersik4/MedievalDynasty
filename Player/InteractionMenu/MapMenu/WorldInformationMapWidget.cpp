...
#include "MedievalDynasty/Player/InteractionMenu/MapMenu/WorldInformationMapWidget.h"
...
void UWorldInformationMapWidget::NativeOnInitialized()
{
...
void UWorldInformationMapWidget::UpdateWorldInformations()
{
...
void UWorldInformationMapWidget::UpdateDayInformation(TObjectPtr<class UMedievalGameInstance> MedievalGameInstance)
{
...
void UWorldInformationMapWidget::UpdateRelationsInformation(TObjectPtr<class UMedievalGameInstance> MedievalGameInstance)
{
